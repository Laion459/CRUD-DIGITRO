                        ...
                        <tbody>
                            ...
                            <?php while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) : ?>
                                <tr data-id="<?php echo $row['id']; ?>">
                                    ...
                                    <td data-label="Email"><?php echo htmlspecialchars(strtoupper($row['email'])); ?></td>
                                    <td data-label="Marital Status"><?php echo htmlspecialchars(strtoupper($row['marital_status'])); ?></td>
                                    <td data-label="Actions" class="td-container">
                                        ...
                                        <a href="update.php?id=<?php echo $row['id']; ?>" class="button edit">
                                            <span class="edit-icon">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pencil-square" viewBox="0 0 16 16">
                                                    <path d="M15.502 1.94a.5.5 0 0 1 0 .706l-1 1-2.5-2.5 1-1a.5.5 0 0 1 .707 0l1.793 1.793zM13.5 3.207l-2.5-2.5-6.814 6.814a.5.5 0 0 0-.121.196l-.805 2.414a.25.25 0 0 0 .316.316l2.414-.805a.5.5 0 0 0 .196-.12l6.813-6.814z" />
